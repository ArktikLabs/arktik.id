...
const BRIEF_SCHEMA = {
  ...
  properties: {
    ...
    claims: { type: 'array', minItems: 3, maxItems: 5, items: { type: 'object', additionalProperties: false, required: ['claim', 'backing'], properties: { claim: { type: 'string' }, backing: { type: 'string' } } } },
