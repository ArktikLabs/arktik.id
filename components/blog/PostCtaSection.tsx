    ...
    <section className={cn('relative overflow-hidden rounded-2xl border border-lime-green/20 bg-gradient-to-br from-lime-green/10 via-lime-green/5 to-transparent p-10 shadow-lg', className)}>
      ...
      <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-shrink-0 gap-3 md:flex-row md:items-center">
          <Link
            href={contactHref}
            className="inline-flex items-center justify-center gap-2 rounded-full bg-lime-green px-6 py-3 text-sm font-semibold text-carbon transition-colors hover:bg-lime-green/90"
          >
            {primaryCta}
          ...
          <Link
            href={servicesHref}
            className="inline-flex items-center justify-center gap-2 rounded-full border border-lime-green/40 px-6 py-3 text-sm font-semibold text-lime-green transition-colors hover:border-lime-green hover:text-ink"
          >
            {secondaryCta}
          </Link>
        </div>
